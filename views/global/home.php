...
<section class="container my-5">
    <div class="row">
        <div class="col-md-4 col-sm-12">
            <h1 class="text-success text-center">Best Offers</h1>
            <p>Protech Computer Services and Printing Shop create a wonderful design. The set back of the system is that the costumers targeted are adults with access to computer systems.</p>
        </div>
        <div class="col-md-4 col-sm-12">
            <h1 class="text-success text-center">100% Satisfy</h1>
            <p>Protech Computer Services and Printing Shop create a wonderful design. The set back of the system is that the costumers targeted are adults with access to computer systems.</p>
        </div>
        <div class="col-md-4 col-sm-12">
            <h1 class="text-success text-center">New Products</h1>
            <p>Protech Computer Services and Printing Shop create a wonderful design. The set back of the system is that the costumers targeted are adults with access to computer systems.</p>
        </div>
    </div>
</section>
